    ...
    R::BaseRing: Zq + Field + PrimeField,
{
    ...
    let (inst_pose, asg_pose, _shorts, _u32s, _bb_centered, _tcch0, _tcch1, _surfaces_mul, _surfaces_sq, pose_wiring) =
    ...
    R::BaseRing: Zq + Field + PrimeField,
{
    ...
    let (inst_pose, asg_pose, _shorts, _u32s, _bb_centered, _tcch0, _tcch1, _surfaces_mul, _surfaces_sq, _pose_wiring) =
        tiny::build_poseidon_f257_with_cm_coins_and_digit_mul_surfaces_from_ops_with_wiring(
            None,
            &ops_f257,
            ring_dim,
