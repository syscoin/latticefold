...
use super::cm_ir::{
    ...
    add_bal16_same_len_ir, neg_bal16_digits_ir, sub_bal16_same_len_ir,
...
/// enforcing `off ∈ [2,30]`.
///
/// This is used by `mul_bal16_small` where the per-digit carry can exceed 11 in magnitude
/// (e.g. when digits take value -8 and products include 64).
